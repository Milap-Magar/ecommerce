...
const Sidebar = () => {
   ...
   const activeLink = 'flex text-white rounder-sm gap-2 p-1';
   const { pathname } = useRouter();

   return (
      <aside className='bg-pink-500 text-black p-4 h-screen flex flex-col gap-4'>
         ...
         <button className='flex flex-row fixed left-4 bottom-5' onClick={() => signOut()}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
